...
Similar to a `ggplot`, you can tweak *almost* anything on your `{pkgdown}`. Below, I will go through a few simple features to achieve a polished looking site. If you require more specific styling, I recommend [this page](https://pkgdown.r-lib.org/articles/customise.html).
...
What if we want to add more features or change the order of our navbar items?
